...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-bna1lpu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-bna1lpu.containers.anotherwebservice.com/
...
```
git clone git@github.com:alcylion/container-bna1lpu.git
cd container-bna1lpu
```
...
```
docker attach container-bna1lpu
```
